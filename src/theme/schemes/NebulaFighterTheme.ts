...
const colors = {
  gradients: {
    blue1: 'linear-gradient(135deg, #339DBB 0%, #B9D3D7 100%)',
    blue2: 'linear-gradient(135deg, #339DBB 0%, #B9D3D7 100%)',
    blue3: 'linear-gradient(127.55deg, #F1C4A5 3.73%, #B380B3 92.26%)',
    blue4: 'linear-gradient(-20deg, #B9D3D7 0%, #853892 100%)',
    blue5: 'linear-gradient(135deg, #339DBB 10%, #853892 100%)',
    orange1: 'linear-gradient(135deg, #E7C32E 0%, #F1723B 100%)',
    orange2: 'linear-gradient(135deg, #E7C32E 0%, #F1723B 100%)',
    orange3: 'linear-gradient(120deg, #E7C32E 0%, #F1723B 100%)',
    purple1: 'linear-gradient(135deg, #853892 0%, #F1C4A5 100%)',
    purple2: 'linear-gradient(135deg, #B9D3D7 0%, #F1C4A5 100%)',
    purple3: 'linear-gradient(135deg, #853892 0%, #F1C4A5 100%)',
    pink1: 'linear-gradient(135deg, #FBF8FC 0%, #853892 100%)',
    pink2: 'linear-gradient(135deg, #FBF8FC 0%, #853892 100%)',
    green1: 'linear-gradient(135deg, #75C14C 0%, #339DBB 100%)',
    green2: 'linear-gradient(to bottom, #75C14C, #339DBB)',
    black1: 'linear-gradient(100.66deg, #B380B3 6.56%, #F5F5F5 93.57%)',
    black2: 'linear-gradient(60deg, #B380B3 0%, #F1C4A5 100%)'
  },
  shadows: {
    success:
      '0px 1px 4px rgba(68, 214, 0, 0.25), 0px 3px 12px 2px rgba(68, 214, 0, 0.35)',
    error:
      '0px 1px 4px rgba(241, 114, 59, 0.25), 0px 3px 12px 2px rgba(241, 114, 59, 0.35)',
    info:
      '0px 1px 4px rgba(51, 157, 187, 0.25), 0px 3px 12px 2px rgba(51, 157, 187, 0.35)',
    primary:
      '0px 1px 4px rgba(241, 195, 46, 0.25), 0px 3px 12px 2px rgba(241, 195, 46, 0.35)',
    warning:
      '0px 1px 4px rgba(247, 114, 59, 0.25), 0px 3px 12px 2px rgba(247, 114, 59, 0.35)',
    card: '0px 0px 2px #B9D3D7',
    cardSm: '0px 0px 2px #B9D3D7',
    cardLg:
      '0 0rem 14rem 0 rgb(245 245 245 / 20%), 0 0.8rem 2.3rem rgb(251 248 252 / 3%), 0 0.2rem 0.7rem rgb(241 196 165 / 15%)'
  },

  layout: {
    general: {
      bodyBg: '#F5F5F5' // update to a brighter color
    },
    sidebar: {
      ...
      menuItemBg: '#272C48', // update to a brighter color
